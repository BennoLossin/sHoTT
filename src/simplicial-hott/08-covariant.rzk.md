...
A similar result holds for hom2.

```rzk
#def sigma-dhom2-hom2
  ( A : U)
  ( B : A → U)
  ( x y z : total-type A B)
  ( f : hom (total-type A B) x y)
  ( g : hom (total-type A B) y z)
  ( h : hom (total-type A B) x z)
  ( α : hom2 (total-type A B) x y z f g h)
  : Σ ( β : hom2 A (π₁ x) (π₁ y) (π₁ z)
    ( π₁ (sigma-dhom-hom A B x y f))
    ( π₁ (sigma-dhom-hom A B y z g))
    ( π₁ (sigma-dhom-hom A B x z h)))
  , dhom2 A (π₁ x) (π₁ y) (π₁ z)
    ( π₁ (sigma-dhom-hom A B x y f))
    ( π₁ (sigma-dhom-hom A B y z g))
    ( π₁ (sigma-dhom-hom A B x z h))
    ...
    ( π₂ (sigma-dhom-hom A B y z g))
    ( π₂ (sigma-dhom-hom A B x z h))
  := (\ (s , t) → π₁ (α (s , t)) , \ (s , t) → π₂ (α (s , t)))

#def hom2-sigma-dhom2
  ( A : U)
  ( B : A → U)
  ( x y z : total-type A B)
  ( f : hom (total-type A B) x y)
...
Similarly the proofs are also obvious.

```rzk
#def is-equiv-sigma-dhom2-hom2
  ( A : U)
  ( B : A → U)
  ( x y z : total-type A B)
  ( f : hom (total-type A B) x y)
  ...
  : is-equiv
    ...
    , dhom2 A (π₁ x) (π₁ y) (π₁ z)
      ...
      ( π₂ (sigma-dhom-hom A B y z g))
      ( π₂ (sigma-dhom-hom A B x z h)))
    ( sigma-dhom2-hom2 A B x y z f g h)
  :=
  is-equiv-has-inverse
  ( hom2 (total-type A B) x y z f g h)
  ( Σ ( β : hom2 A (π₁ x) (π₁ y) (π₁ z)
  ...
  , dhom2 A (π₁ x) (π₁ y) (π₁ z)
    ...
    ( π₂ (sigma-dhom-hom A B x z h)))
  ( sigma-dhom2-hom2 A B x y z f g h)
  ( hom2-sigma-dhom2 A B x y z f g h , (\ _ → refl , \ _ → refl))

#def is-equiv-hom2-sigma-dhom2
  ( A : U)
  ( B : A → U)
  ( x y z : total-type A B)
  ( f : hom (total-type A B) x y)
  ...
  : is-equiv
    ...
    , dhom2 A (π₁ x) (π₁ y) (π₁ z)
      ...
      ( π₂ (sigma-dhom-hom A B x z h)))
    ( hom2 (total-type A B) x y z f g h)
    ( hom2-sigma-dhom2 A B x y z f g h)
  :=
  is-equiv-has-inverse
  ( Σ ( β : hom2 A (π₁ x) (π₁ y) (π₁ z)
    ( π₁ (sigma-dhom-hom A B x y f))
  ...
  ( hom2 (total-type A B) x y z f g h)
  ( hom2-sigma-dhom2 A B x y z f g h)
  ( sigma-dhom2-hom2 A B x y z f g h , (\ _ → refl , \ _ → refl))

#def equiv-hom2-sigma-dhom2
  ( A : U)
  ( B : A → U)
  ( x y z : total-type A B)
  ( f : hom (total-type A B) x y)
  ...
  : Equiv
    ...
    , dhom2 A (π₁ x) (π₁ y) (π₁ z)
      ...
      ( π₂ (sigma-dhom-hom A B x z h)))
  :=
  ( sigma-dhom2-hom2 A B x y z f g h , is-equiv-sigma-dhom2-hom2 A B x y z f g h)

#def equiv-sigma-dhom2-hom2
  ( A : U)
  ( B : A → U)
  ( x y z : total-type A B)
  ( f : hom (total-type A B) x y)
  ...
  : Equiv
    ...
    ( hom2 (total-type A B) x y z f g h)
  :=
  ( hom2-sigma-dhom2 A B x y z f g h , is-equiv-hom2-sigma-dhom2 A B x y z f g h)
```
