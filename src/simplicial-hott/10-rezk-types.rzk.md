...
#def is-full-emb-isos uses (extext)
  ...
  :=
  is-full-emb-is-emb-is-discrete TODO
  ( Iso A is-segal-A x y) (hom A x y) (\ f → π₁ f)
  ( is-emb-subtype-projection (hom A x y) (is-iso-arrow A is-segal-A x y)
    ( is-prop-is-iso-arrow A is-segal-A x y))
  ( is-discrete-hom-is-segal A is-segal-A x y)
```
...
#def iso-eq-iso-is-rezk'
  ...
  :=
  ( π₂ (has-section-is-equiv (x = y) (Iso A (π₁ is-rezk-A) x y)
      ( iso-eq A (π₁ is-rezk-A) x y) ((π₂ is-rezk-A) x y)))
  iso
